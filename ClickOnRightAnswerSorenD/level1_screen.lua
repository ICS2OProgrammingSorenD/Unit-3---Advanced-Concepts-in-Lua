...
-- SOUND
-----------------------------------------------------------------------------------------
local incorrectSound = audio.loadSound( "Sounds/booing.mp3" )
local incorrectSoundChannel

local correctSound = audio.loadSound( "Sounds/cheer.mp3" )
...
local function DetermineAnswers()
    ...
    wrongAnswer1 = math.random(5,8) + math.random(1,4)
    wrongAnswer2 = math.random(9,15) + math.random(5,8)
    wrongAnswer3 = math.random(1,4) + math.random(9,15)
end
...
local function youWin()
    -- if they get 3 answers correct then got to the You Win screen
...
local function TouchListenerAnswer(touch)
    ...
    if (touch.phase == "ended") and (alreadyClickedAnswer == false) then
        ...
        if (answer == tonumber(userAnswer)) then     
            ...
            --call you Win fuction if neccesary
            youWin()
        end        
...
function scene:create( event )
    ...
    congratulationText:setTextColor(60/255, 237/255, 0)
    congratulationText.isVisible = false

    -- create the text object that will say Correct, set the colour and then hide it
    correct = display.newText("Correct!", 300, 600, nil, 50 )
    correct:setTextColor(71/255, 198/255, 202/255)
    correct.isVisible = false
    correct:scale(2, 2)

    -- create the text object that will say Correct, set the colour and then hide it
    incorrect = display.newText("Incorrect!", 300, 600, nil, 50 )
    incorrect:setTextColor(246/255, 16/255, 16/255)
    incorrect.isVisible = false
    incorrect:scale(2, 2)
